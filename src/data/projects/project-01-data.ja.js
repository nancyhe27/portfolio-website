export const project01Data = {
  ...
  "sections": [
      ...
      "subsections": [
        {
          ...
          "subtitle": "会社について",
          "paragraphs": [
            "WeKruitは、AI駆動ツールを通じて採用担当者と候補者の両方の面接プロセスを合理化することを目指すB2B SaaSスタートアップです。"
          ]
        },
        {
          "id": 2,
          "subtitle": "製品について",
          "paragraphs": [
            "WeKruitの面接管理ダッシュボードに取り組みました。これは、スケジューリング、面接、レビューを一元化するコア製品です。録画、トランスクリプト、AI生成スコアを組み合わせて、評価をより迅速かつ明確にします。"
          ]
        },
        {
          "id": 3,
          "subtitle": "ユーザーについて",
          "paragraphs": [
            "ダッシュボードは、毎日数十回の面接を実施し、シンプルでアクション駆動のワークフローを必要とする採用担当者と採用マネージャー向けに構築されています。"
          ]
        },
        {
          "id": 4,
          "subtitle": "インパクト",
          "paragraphs": [
            "3つのクライアント企業で1,000件以上の面接を合理化し、100人以上の学生がよりスムーズなモックセッションを実行できるようになりました。"
          ]
        }
      ]
    },
    {
      ...
      "title": "私が行ったこと",
      "paragraphs": [
        "プロダクトUI設計とプロトタイプ – ワイヤーフレームからコード化されたプロトタイプまで機能を開発",
        "• 面接ダッシュボード（プロトタイプ）",
        "• AI面接プロセス（プロトタイプ）",
        "",
        "デザインシステム – スケーラブルなトークンと再利用可能なデザインコンポーネントを作成",
        "",
        "新しいUIデザイン – デザインシステムで既存のインターフェースを再設計",
        "• 面接ダッシュボード（新規）",
        "• AI面接プロセス（新規）",
        "",
        "製品デリバリー – 再設計されたUIをコードベースに統合"
      ]
    },
    {
      "id": 3,
